...
export default function CommunityPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center h-full min-h-[70vh] text-center px-4">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-3">Teman & Komunitas</h1>
      <p className="text-gray-500 max-w-md text-lg mb-8">
        Temukan teman dengan minat baca yang sama, buat grup diskusi, dan ikuti acara-acara komunitas perpustakaan.
      </p>
