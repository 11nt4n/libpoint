...
export default function AdminRedemptionsPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center h-full min-h-[70vh] text-center px-4">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-3">Approval Penukaran Poin</h1>
      <p className="text-gray-500 max-w-md text-lg mb-8">
        Kelola permintaan penukaran poin dari anggota, dan konfirmasi pengambilan *merchandise*.
      </p>
