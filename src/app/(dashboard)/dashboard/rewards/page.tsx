...
export default function RewardsPage() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center h-full min-h-[70vh] text-center px-4">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-3">LibMerch (Tukar Poin)</h1>
      <p className="text-gray-500 max-w-md text-lg mb-8">
        Tukarkan poin yang Anda kumpulkan dengan berbagai *merchandise* menarik dan hadiah eksklusif dari Perpustakaan.
      </p>
      
      <div className="bg-amber-50 border border-amber-200 text-amber-700 px-6 py-4 rounded-xl flex items-center gap-3">
        <Wrench className="w-5 h-5 text-amber-600" />
        <span className="font-medium">Halaman ini sedang dalam tahap pengembangan. Segera hadir!</span>
      </div>
    </div>
  );
}
